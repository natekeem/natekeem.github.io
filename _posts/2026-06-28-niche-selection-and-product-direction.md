---
title: "수익형 블로그 1호를 고르기 전에: 주제 후보 10개를 다시 평가했다"
...
tags:
  ...
  - Monetization
  - Dev Log
description: "AI 블로그 자동화 프로젝트를 단순 자동 발행 실험이 아니라 수익형 콘텐츠 운영 시스템으로 발전시키기 위해, 영어권 수익형 블로그 후보 10개를 평가하고 1호 블로그 방향을 정한 기록."
published: true
image:
  path: /assets/img/posts/2026-06-28-niche-selection-and-product-direction/cover.png
  alt: "수익형 블로그 후보를 비교하고 스마트홈 주제를 첫 번째로 선택하는 장면"
---
...
1. GitHub repo, domain, site 정보를 연결한다.
2. 주제 후보를 만들고 사람이 승인하거나 보류한다.
3. brief, draft, image, SEO checklist, human review를 한 흐름에서 관리한다.
4. 발행 준비가 된 글만 publish 단계로 넘긴다.
5. 발행 후 sitemap, robots, public URL, Search Console 메모를 추적한다.
...
먼저 `The Smart Suburbanite MVP planning`을 해야 한다.
